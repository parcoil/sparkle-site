				...
				<div className="flex w-full max-w-5xl flex-col items-center justify-center">
					...
					<div className="mb-6 flex flex-col space-y-2 text-center sm:flex-row sm:space-y-0 sm:space-x-4 sm:text-left">
						<p className="text-sm font-medium text-muted-foreground">
							Latest Version <span className="font-semibold text-primary">{version}</span>
						</p>
						<p className="text-sm font-medium text-muted-foreground">
							Downloads <span className="font-semibold text-primary">{downloads}</span>
						</p>
					</div>
					...
					<div className="hidden w-full flex-col justify-center space-y-2 sm:flex sm:w-auto sm:flex-row sm:space-y-0 sm:space-x-4">
						...
						<a href="https://github.com/Parcoil/Sparkle" className="w-full sm:w-auto">
					...
					<div className="group relative mt-4 hidden w-full sm:mt-6 sm:flex sm:max-w-md">
						...
						>
							...
							<span className="font-mono text-sm">irm https://getsparkle.net/get | iex</span>
						</button>
					...
					<div className="mt-4 flex flex-col items-center justify-center space-y-2 px-4 text-center sm:hidden">
						...
						<div className="mt-12 w-full rounded-2xl bg-muted py-12 dark:border dark:border-accent dark:bg-muted/20">
							<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
								<div className="text-center">
									...
									>
										<a href="/apps">
											Browse Apps <ArrowRight className="-mr-1 ml-2 h-5 w-5" />
										</a>
									</Button>
								</div>
							</div>
